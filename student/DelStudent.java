...
import utility.DB;
import utility.NJDatePicker;
import utility.NTextField;
...
import java.awt.*;
public class DelStudent extends JDialog
{
    JLabel lid;
    JComboBox cmstid;
    ...
    public DelStudent(JFrame parent,String title,boolean state,DB ref)
    {
        super(parent,"Delete Student",state);
        this.ref=ref;

        dst=this;
       
        head = new JLabel("Delete Student");
        ...
        cmstid.addActionListener(new ActionListener() {
        ...
        del.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e)
            {
                try
                {
                    ref.pstdel.setInt(1,sid);
                    ref.pstdel.executeUpdate();
                    setVisible(false);
                }
                catch(Exception e1){}
